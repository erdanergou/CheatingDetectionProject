...
class SimpleTransform(object):
    ...
    dataset:
        ...
        要转换的数据集，必须包含用于翻转的joint_pairs属性。
    scale_factor: int
        Scale augmentation.
    input_size: tuple
    ...
    def __init__(self, scale_factor, add_dpg,
        ...
        """
        :param scale_factor:  放缩参数
        :param add_dpg:添加dpg操作（深度确定性策略梯度）
